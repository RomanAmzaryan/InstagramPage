export const NavigationLogoIcon = () => {
  return (
    <div className="Logo">
      <svg
...
export const NavigationSearchIcon = () => {
  return (
    <div className="NavLink modalS">
      <svg
        aria-label="Search"
        className="x1lliihq x1n2onr6 x5n08af modalS"
        fill="currentColor"
        height="24"
        role="img"
        viewBox="0 0 24 24"
      ...
      <span className="modalS">Search</span>
    </div>
  );
};
export const NavigationExploreIcon = () => {
  return (
    <div className="NavLink">
      <svg
        aria-label="Explore"
...
export const NavigationReelsIcon = () => {
  return (
    <div className="NavLink">
      <svg
        aria-label="Reels"
...
export const NavigationMessagesIcon = () => {
  return (
    <div className="NavLink">
      <svg
...
export const NavigationCreateIcon = () => {
  return (
    <div className="NavLink">
      <svg
        aria-label="New post"
...
export const NavigationThreadsIcon = () => {
  return (
    <div className="NavLink">
      <svg
        aria-label=""
...
export const NavigationMoreIcon = () => {
  return (
    <div className="NavLink">
      <svg
        aria-label="Settings"
...
export const SettingsIcon = () => {
  return (
    <div className="x9f619 x1n2onr6 x1ja2u2z xdt5ytf x2lah0s x193iq5w xeuugli xamitd3 x78zum5">
      <div className="x9f619 xjbqb8w x78zum5 x168nmei x13lgxp2 x5pf9jr xo71vjh xq8finb x1uhb9sk x1plvlek xryxfnj x1c4vz4f x2lah0s xdt5ytf xqjyukv x1qjc9v5 x1oa3qoh x1nhvcw1">
        <svg
          aria-label="Settings"
          className="x1lliihq x1n2onr6 x5n08af"
          fill="currentColor"
...
export const InstaLogo = () => {
  return (
    <div className="x9f619 xxk0z11 xii2z7h x11xpdln x19c4wfv xvy4d1p instagramLogo">
      <svg
        aria-label="Instagram"
        className="x1lliihq x1n2onr6 x5n08af"
        fill="currentColor"
...
export const SearchDeleteIcon = () => {
  return (
    <svg
      aria-label="Close"
      className="x1lliihq x1n2onr6 x1roi4f4 closeFollowersModal"
      fill="currentColor"
      height="16"
      role="img"
      viewBox="0 0 24 24"
...
export const UserMessageIcon = () => {
  return (
    <div className="x2lah0s x1i64zmx x1iorvi4">
      <svg
...
export const BackRequest = () => {
  return (
    <div className="x6s0dn4 x78zum5 xdt5ytf xl56j7k BackRequest">
      <span className="">
        <svg
          aria-label="Back"
          className="x1lliihq x1n2onr6 x5n08af"
...
export const RequestHidden = () => {
  return (
    <div className="x78zum5 x2lah0s xn6708d hiddenItem">
      <div className="x9f619 x78zum5 x1uhb9sk x1plvlek xryxfnj x1c4vz4f x2lah0s x1q0g3np xqjyukv x6s0dn4 x1oa3qoh xl56j7k x19g9edo x14yjl9h xudhj91 x18nykt9 xww2gxu xnnlda6 x15yg21f">
        <svg
...
export const RightRequest = () => {
  return (
    <svg
      aria-label="Chevron icon to indicate entering the hidden requests window"
      className="x1lliihq x1n2onr6 x5n08af"
      fill="currentColor"
      height="16"
      role="img"
    ...
    >
      <title>
        Chevron icon to indicate entering the hidden requests window
      </title>
...
export const SmileMessage = () => {
  return (
    <div className="x6s0dn4 x78zum5 xdt5ytf xl56j7k smile">
      <svg
