...
const FollowersModalBlock = ({ followersModal, OtherProfilFollowers, activeUser, postItemFollowers, unFollowItem }) => {
  ...
  return (
    <div ref={followersModal} onClick={followersModalClose} className="FollowersModalDiv followersModalDivNone">
                  ...
                  <div>
                    {activeUser?.id !== user.id &&
                      (activeUser?.following.find((el) => el === user.id) ? (
                        <button className="OtherProfilFollowBtn UnFollow" onClick={() => unFollowItem(user)}>
                          {" "}
                          UnFollow
                        </button>
                      ) : (
                        <button className="OtherProfilFollowBtn" onClick={() => postItemFollowers(user)}>
                          Follow
                        </button>
                      ))}
                  </div>
...
export default FollowersModalBlock;
